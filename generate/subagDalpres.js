const dataDalpres = [
    ["giat", "APEL DI MAKO POLRES", 3, 1, "-"],
    ["dok", "MEMBUAT SPRINT TUGAS", 1, 3, "-"],
    ["dok", "MENGUPDATE SIPK ONLINE", 1, 2, "-"],
    ["dok", "ADMINISTRASI MENGENAI UKGB", 1, 2, "-"],
    ["dok", "MENGUPDATE DATA PADA APLIKASI SIPP", 1, 2, "-"],
    ["dok", "PELAKSANAAN ADMINISTRASI ASSESMEN", 1, 4, "-"],
